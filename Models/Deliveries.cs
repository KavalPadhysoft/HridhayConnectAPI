...
{
      public class Deliveries : EntityBase
      {
            [Key]
    ...
    public class DeliveriesDetails : EntityBase
    {
        [Key]
    ...
    public class DeliveriesCombo
    {
        public Deliveries Order { get; set; } = new();
        public List<DeliveriesDetails> DeliveryItems { get; set; } = new();
    }
